...
def main(filename, motors, ref_motor):
	...
	for motor in motors:
		...
		y_amp = muscle[muscle_peaks]
		plt.figure(2)
		plt.plot(x,y_amp,color=color_pallette[motor],linewidth=2,label="Muscle "+str(motor_to_muscle[motor]))
...
'''
# FB to FS
filename = "/home/roboy/dep/data/combination/10FB04FS_04FB10FS_200s_2017-10-18-12-50-31.bag"
ref_motor = 5
muscles = [1,2,3,4,5,6]
swap = [0,0,0,0,0,0]
'''
...
'''
# FB to SD
filename = "/home/roboy/dep/data/combination/10FB04SD_04FB10SD_200s_2017-10-18-12-55-03.bag"
ref_motor = 5
muscles = [1,2,3,4,5,6]
swap = [1,0,0,0,0,0]
'''
...
# FS to SD
filename = "/home/roboy/dep/data/combination/10FS04SD_04FS10SD_200s_2017-10-18-12-59-53.bag"
ref_motor = 1 
muscles = [1,2,3,4,5,6]
swap = [0,1,1,0,1,0]
...
'''
# SD to FB
filename = "/home/roboy/dep/data/combination/10SD04FB_04SD10FB_200s_2017-10-18-13-04-33.bag"
ref_motor = 5 
muscles = [1,2,3,4,5,6]
swap = [1,0,0,0,0,0]
'''
